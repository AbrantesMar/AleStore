...
extension ItemViewController: ViewManager {
    ...
    public func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            actualPriceLabel.leadingAnchor.constraint(equalTo: contentArea.leadingAnchor),
            ...
            priceLabel.leadingAnchor.constraint(equalTo: actualPriceLabel.trailingAnchor),
